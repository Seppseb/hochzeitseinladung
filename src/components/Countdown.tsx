...
const Countdown = () => {
  ...
  const timerComponents = Object.entries(timeLeft).map(([interval, value]) => (
    <div key={interval} className="text-center">
      <div className="text-4xl md:text-6xl font-heading text-lavender-dark">
  ...
  return (
    <div className="flex justify-center gap-4 md:gap-8">
      {timerComponents.length ? timerComponents : <span className="text-2xl font-heading text-love-pink">Der große Tag ist da!</span>}
    </div>
  );
};
